...
from valkka.streamer.multiprocess.rgb import RGB24Process
...
class ClientProcess(RGB24Process):
    ...
    def __init__(self,
        ...
        self.data_name_server = str(id(self))+"-data"
        _, self.data_server_ipc = event_fd_group_1.reserve() # index, EventFd
        self.logger.debug("data ipc fd=%s", self.data_server_ipc.getFd())
        #
    ...
    def preRun__(self):
        ...
        self.logger.debug("preRun__: using eventfd %s",
    ...
    def handleFrame__(self, frame, meta):
        ...
        ## WARNING: if too big a frame is sent, the client will hang
    ...
    def getDataShmemPars(self): # DATASERVER
        """this is used by downstream (websocket) multiprocess
